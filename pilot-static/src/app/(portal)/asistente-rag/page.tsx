...
import type { RagChatMessageInput, RagModuleScope, RagSource } from "@/lib/rag/types";
...
const initialAssistantMessage: UiMessage = {
  ...
  role: "assistant",
  content:
    "Soy el Asistente RAG demo de ARGOS (modo estatico). Puedo responder sobre modulos, flujos operativos, estados e integraciones usando una base de conocimiento simulada.",
